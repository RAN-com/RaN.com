...
const Tech = () => {
  return (
    ...
    transition={{duration:1.5}}
     className="flex flewx-warp items-center justify-center gap-4">
        {/* <h1 className='my-20 text-center font-bold animate-rgb text-4xl underline'>Development Tools   </h1> */}
        <motion.div
    ...
    transition={{duration:1.5}}
     className="flex flewx-warp items-center justify-center gap-4">
        ...
        {/* <h1 className='my-20 text-center  font-bold animate-rgb text-4xl underline'>Design Tools </h1> */}
    </motion.div>
